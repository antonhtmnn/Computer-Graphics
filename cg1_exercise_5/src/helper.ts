...
export function setupGeometry(scene: THREE.Scene){
  ...
  var boxGeometry = new THREE.BoxGeometry( 100/300, 300/300, 100/300 );
  var sphere = new THREE.Mesh( sphereGeometry, phongMaterialRed );
  sphere.position.set( - 50/300, - 250/300 + 5/300, - 150/300 );
  scene.add(sphere);
  var sphere2 = new THREE.Mesh( sphereGeometry, phongMaterialGreen );
  sphere2.position.set( 175/300, - 250/300 + 5/300, - 100/300 );
  scene.add(sphere2);

  var sphere3 = new THREE.Mesh( sphereGeometry, phongMaterialBlue );
  sphere3.position.set( 75/300, - 250/300 + 5/300, - 30/300 );
  sphere3.rotation.y = 0.5;
  scene.add( sphere3 );

  var box = new THREE.Mesh( boxGeometry, mirrorMaterial );
  box.position.set( - 175/300, - 250/300 + 100/300, - 150/300 );
  box.rotation.y = 0.25;
  scene.add(box);
...
export function setupLight(scene: THREE.Scene){
  ...
  var light2 = new THREE.PointLight( 0xfaaa55, intensity );
  light2.position.set( - 200/300, 100/300, 100/300 );
  scene.add(light2);
  lights.push(light2);
  light2.updateMatrixWorld();

  var light3 = new THREE.PointLight( 0x5aaaff, intensity );
